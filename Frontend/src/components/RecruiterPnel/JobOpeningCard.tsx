...
export default function JobOpeningCard({ job, onUploadCandidate, candidateCount }: JobOpeningCardProps) {
  return (
    <motion.div
    ...
    >
      ...
      <div className="space-y-2 mb-6">
        ...
        <div className="flex items-center gap-2 text-sm text-slate-600">
          <Target size={16} />
          <span>{job.openPositions} {job.openPositions === 1 ? 'position' : 'positions'}</span>
        </div>
      </div>
