...
//   const reports = [
//     { title: "User Report", endpoint: "/admin/reports/users" },
//     { title: "Job Report", endpoint: "/admin/reports/jobs" },
//     { title: "Leave Report", endpoint: "/admin/reports/leaves" },
//   ];
...
//             </h2>
//             <button
//               onClick={() => downloadReport(r.endpoint)}
