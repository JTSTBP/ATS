...
export const ManagerCandidates = ({ initialJobTitleFilter = "all", initialFormOpen = false }: { initialJobTitleFilter?: string, initialFormOpen?: boolean }) => {
  ...
  const handleDelete = async (candidateId: string) => {
    ...
    const success = await deleteCandidate(candidateId, user?.designation || "Manager");
    if (success) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-bold text-gray-800 mb-2">Candidates (Manager View)</h2>
              ...
              <tr>
                ...
                {statusFilter === "Joined" && (
                  <>
                    ...
                    <th className="px-6 py-3 text-left text-sm font-semibold">Offer Letter</th>
                  </>
                )}
                {statusFilter === "Selected" && (
                  <>
                    <th className="px-6 py-3 text-left text-sm font-semibold">Selection Date</th>
                    <th className="px-6 py-3 text-left text-sm font-semibold">Expected Joining Date</th>
                  </>
                )}
                ...
                <th className="px-6 py-3 text-left text-sm font-semibold">Reportees</th>
                  ...
                  <tr key={candidate._id} className="hover:bg-gray-50 transition">
                    ...
                    <td className="px-6 py-4">
                      {candidate.resumeUrl ? (
                        ...
                        >
                          <Upload className="w-4 h-4 mr-1" /> View Resume
                        </a>
