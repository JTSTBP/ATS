import { Download, TrendingUp, Users, FileText, CheckCircle, Calendar } from 'lucide-react';
    ...
    <div className="p-8">
      <div className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Analyze hiring metrics and performance</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        <div className="bg-white rounded-lg border border-gray-200">
          <div className="p-6 border-b border-gray-200">
            ...
            <p className="text-sm text-gray-600 mt-1">Application to hire conversion rates</p>
          </div>
          <div className="p-6">
        ...
        <div className="bg-white rounded-lg border border-gray-200">
          <div className="p-6 border-b border-gray-200">
            ...
            <p className="text-sm text-gray-600 mt-1">Most applied and hired positions</p>
          </div>
          <div className="p-6">
            <div className="space-y-4">
              {topPositions.map((position) => (
                <div key={position.position} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  <div>
                    <div className="font-medium text-gray-900">{position.position}</div>
                    <div className="text-sm text-gray-600 mt-1">
                      {position.applications} applications
                    </div>
                  </div>
                  <div className="text-right">
                    <div className="text-2xl font-bold text-green-600">{position.hired}</div>
      ...
      <div className="bg-white rounded-lg border border-gray-200">
        <div className="p-6 border-b border-gray-200">
          ...
          <p className="text-sm text-gray-600 mt-1">Applications and hiring trends over time</p>
        </div>
        <div className="p-6">
                    ...
                    <div className="flex items-center gap-4">
                      <div className="flex-1">
                        <div className="flex items-center justify-between mb-1">
                          ...
                          <span className="text-xs font-medium text-gray-900">{data.applications}</span>
                        </div>
                        <div className="w-full bg-gray-200 rounded-full h-2">
                          <div
                      ...
                      <div className="flex-1">
                        <div className="flex items-center justify-between mb-1">
                          ...
                          <span className="text-xs font-medium text-gray-900">{data.hired}</span>
                        </div>
                        <div className="w-full bg-gray-200 rounded-full h-2">
                          <div
