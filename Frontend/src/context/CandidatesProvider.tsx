...
type CandidateContextType = {
  ...
  createCandidate: (data: Candidate) => Promise<Candidate | null>;
  updateCandidate: (id: string, data: Candidate) => Promise<Candidate | null>;
  deleteCandidate: (id: string) => Promise<boolean>;
  updateStatus: (id: string, status: string) => Promise<Candidate | null>;
};
...
export const CandidateProvider: React.FC<{ children: React.ReactNode }> = ({
  ...
  const createCandidate = async (candidate, file) => {
    try {
